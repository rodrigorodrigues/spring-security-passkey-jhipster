...
describe('Post e2e test', () => {
  ...
  const postSample = {
    title: 'immediate pfft punctual',
    content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=',
    date: '2025-02-14T15:47:33.389Z',
  };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('quiet lay tapioca');
      cy.get(`[data-cy="title"]`).should('have.value', 'quiet lay tapioca');
      ...
      cy.get(`[data-cy="date"]`).type('2025-02-14T11:39');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2025-02-14T11:39');
