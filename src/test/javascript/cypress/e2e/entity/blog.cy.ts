...
describe('Blog e2e test', () => {
  ...
  const blogSample = { name: 'cuckoo draw', handle: 'sock modulo' };
  ...
  describe('new Blog page', () => {
    ...
    it('should create an instance of Blog', () => {
      cy.get(`[data-cy="name"]`).type('clinking onto positively');
      cy.get(`[data-cy="name"]`).should('have.value', 'clinking onto positively');

      cy.get(`[data-cy="handle"]`).type('lone voluntarily');
      cy.get(`[data-cy="handle"]`).should('have.value', 'lone voluntarily');
