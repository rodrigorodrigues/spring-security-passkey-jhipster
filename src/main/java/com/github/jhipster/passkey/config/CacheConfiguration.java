...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            ...
            createCache(cm, com.github.jhipster.passkey.domain.User.class.getName(), jcacheConfiguration);
            createCache(cm, com.github.jhipster.passkey.domain.Authority.class.getName(), jcacheConfiguration);
